...
list_theme() {
  ...
  echo "6. Thema Stellar"
  echo "7. Thema Billing"
  echo "8. Thema Enigma"
  echo "x. Exit"
  echo -e "Masukkan pilihan (6/7/8/x)"
  read -r MENU_CHOICE
  clear
# Install theme
install_theme() {
...
if [ "$SELECT_THEME" -eq 6 ]; then
  ...
  echo ""
  echo "Pilihan tidak valid. silahkan pilih 6/7/8"
fi
}
